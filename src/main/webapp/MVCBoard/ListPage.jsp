...
<body>
    ...
    <!-- 
    검색 폼 : 검색어 입력 후 '검색' 버튼을 누르면 현재페이지로 입력한 폼값이 전송된다.
    get방식이므로 파라미터는 쿼리스트링을 통해 전달받을 수 있다.-->
    <form method="get">  
    <table border="1" width="90%">
    <tr>
        <td align="center">
        <!-- 검색을 위한 테이블의 컬럼명을 지정함  -->
...
<c:choose>
	<c:when test="${ empty boardLists }">
		<!-- boardLists에 저장된 값이 없다면 등록된 게시물이 없거나,
		검색된 게시물이 없는 경우임.  -->
        <tr>
	...
	<c:otherwise>
	<!-- boardLists에 저장된 레코드가 있다면 크기만큼 반복해서 출력한다.
